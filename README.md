...
This repository forked from [nodejs-package](https://github.com/hexlet-boilerplates/nodejs-package).
That is created and maintained by the team and the community of Hexlet, an educational project. [Read more about Hexlet (in Russian)](https://ru.hexlet.io/pages/about?utm_source=github&utm_medium=link&utm_campaign=nodejs-package).
##
